                ...
                <div class="spt-post">
                    <!-- <div class="spt-post-box">
                        <div class="spt-box-info">
                            ...
                            <p class="py-4">Steady and proﬁtable referral traffic requires more than quality health care. Even if the most highly reputed specialists take a passive approach to referral marketing, they often struggle to maintain a viable level of incoming referrals.</p>
                            <div class="spt-box-btn">
                                ...
                                <a href="" class="read-btn">Read More <img src="<?php echo get_template_directory_uri(); ?>/assets/img/btn-arrow.svg" alt=""></a>
                            </div>
                        </div>
                        <div class="spt-box-img">
                            <img src="<?php echo get_template_directory_uri();?>/assets/img/ser1.png" alt="">
                        </div>
                    </div> -->
